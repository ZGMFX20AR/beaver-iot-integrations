package com.milesight.beaveriot.integrations.llm.api.model;
...
public class GenerateCompletionRequest {
    ...
    public GenerateCompletionRequest converterPayload(LlmServiceEntities.GenerateCompletion payload) {
